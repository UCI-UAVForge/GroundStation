    ...
    ui(new Ui::MapPlanning)
{
    ...
    //delete = new  (row)
    connect(ui->pushButton_6, SIGNAL(clicked()), this, SLOT(on_pushButton_7_clicked()));

    ui->webView->load(QUrl("file:///Users/navninder/Development/Qt/UCI-SoftwareDev/GUI/UAV-Forge-New/maps.html"));
