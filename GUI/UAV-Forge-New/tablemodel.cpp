...
bool TableModel::insertRow(double latitude, double longitude,const QModelIndex &index){
    ...
    //--This is the section coded and documetned by me (Jordan)--
    ...
    QString action = "Action 1"; // <- This line can be changed once actions have meaning
    QString longString = QString::number(longitude);
    QString latString = QString::number(latitude);
    QString behaviorString = "Behavior 1"; // <- This line can be changed once behaviors have meaning
